...
public class ModJEIPlugin implements IModPlugin {
    public static final IRecipeType<ItemStack> CATEGORY_WITHER_SKELETON_PRODUCER_FOR_WITHER_SKELETON = createRecipeType("wither_skeleton_producer_for_wither_skeleton");
    public static final IRecipeType<ItemStack> CATEGORY_WITHER_SKELETON_PRODUCER_FOR_ROSES = createRecipeType("wither_skeleton_producer_for_roses");
    public static final IRecipeType<ItemStack> CATEGORY_WITHER_SKELETON_BREEDER = createRecipeType("wither_skeleton_breeder");
    public static final IRecipeType<ItemStack> CATEGORY_WITHER_SKELETON_SLAUGHTERER = createRecipeType("wither_skeleton_slaughterer");

    @NotNull
    private static IRecipeType<ItemStack> createRecipeType(@NotNull String name) {
        return IRecipeType.create(ShanxiSkeleton.MOD_ID, name, ItemStack.class);
    }
    ...
    public void registerRecipeCatalysts(@NotNull IRecipeCatalystRegistration registration) {
        registration.addCraftingStation(CATEGORY_WITHER_SKELETON_PRODUCER_FOR_WITHER_SKELETON,
                new ItemStack(ModBlocks.WITHER_SKELETON_PRODUCER));
        registration.addCraftingStation(CATEGORY_WITHER_SKELETON_PRODUCER_FOR_ROSES,
                new ItemStack(ModBlocks.WITHER_SKELETON_PRODUCER));
        registration.addCraftingStation(CATEGORY_WITHER_SKELETON_BREEDER,
                new ItemStack(ModBlocks.WITHER_SKELETON_BREEDER));
        registration.addCraftingStation(CATEGORY_WITHER_SKELETON_SLAUGHTERER,
                new ItemStack(ModBlocks.WITHER_SKELETON_SLAUGHTERER));
    }
