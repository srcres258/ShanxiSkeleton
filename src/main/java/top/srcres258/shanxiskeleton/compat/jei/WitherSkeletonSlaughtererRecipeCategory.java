...
public class WitherSkeletonSlaughtererRecipeCategory implements IRecipeCategory<ItemStack> {
    ...
    public void setRecipe(
        ...
        outputSlots[2].addIngredient(VanillaTypes.ITEM_STACK, new ItemStack(Items.BONE));
        outputSlots[3].addIngredient(VanillaTypes.ITEM_STACK, new ItemStack(Items.WITHER_SKELETON_SKULL));
    }
